namespace NewspaperSystem.Tests.Web.Areas.Identity.Controllers
{
    ...
    public class HomeControllerTests
    {
        ...
        private const string ResetPasswordMessageUpdated = "Password for user \"First\" was successfuly changed!";
        private const string ManageRolesMessageUpdated = "Successfuly changed roles for user \"First\"!";
        ...
        public async Task ChangeUserRolesPost_ShouldReturnRedirectToActionWhenValidUserId()
        {
            ...
            tempDataSuccessMessage.Should().Be(ManageRolesMessageUpdated);
        }
        ...
        public async Task ChangeUserPasswordPost_ShouldReturnRedirectToActionWhenValidUserId()
        {
            ...
            tempDataSuccessMessage.Should().Be(ResetPasswordMessageUpdated);
        }
